          ...
          if(stream.hasData){
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) =>
                    ExcoListItem(excos[index], onTap: (exco){
                        ...
                        children: <Widget>[
                          RaisedButton(
                            ...
                            Navigator.of(context).push(
                                MaterialPageRoute(builder: (context) => AddEditExco(exco))
                            );
                          }),
                          ...
                          RaisedButton(
                            color: Colors.redAccent,
                              ...
                              ExcoDAO.deleteExco(exco.id, (success){
                                if(success){
                                  showShortToast("deleted");
                                }else{
                                  showError(message: "Error deleting");
                                }
                                Navigator.pop(context);
                              });
