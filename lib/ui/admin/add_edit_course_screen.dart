...
//    outlines.addAll();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar:
          AppBar(title: Text("Course Details", textAlign: TextAlign.center)),
      body: Form(
        key: _formKey,
        child: Padding(
...
//                            width: double.infinity,
                      child: FixedDropdownButton<String>(
                        ...
                        value: _courseType,
                        items: ["COMPULSORY", "GENERAL STUDIES", "ELECTIVE"]
                            .map((String value) {
                      ...
                      decoration: ShapeDecoration(
                        shape: RoundedRectangleBorder(
                          side: BorderSide(
                              ...
                              color:
                                  courseTypeError ? Colors.red : Colors.grey),
          ...
          return SimpleDialog(
            ...
            children: <Widget>[
              TextField(
                ...
                decoration: InputDecoration(labelText: "Enter outline"),
              ),
              RaisedButton(
                  onPressed: () {
