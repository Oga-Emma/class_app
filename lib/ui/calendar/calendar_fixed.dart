...
import 'package:class_app/ui/calendar/calendar_tile_fixed.dart';
...
class CalendarFixed extends StatefulWidget {
  ...
  final Function(bool) sizeChanged;
  ...
  @override
  _CalendarFixedState createState() => _CalendarFixedState();
}

class _CalendarFixedState extends State<CalendarFixed> {
  ...
  Widget get nameAndIconRow {
    ...
    if (widget.showTodayIcon) {
      todayIcon = InkWell(
        child: Text('Today'),
//        child: Text(selectedDate == DateTime.now() ? 'Today' : 'Goto Today'),
        onTap: resetToToday,
      );
    } else {
      todayIcon = Container();
      ...
      return GestureDetector(
        ...
        child: Container(
          color: Theme.of(context)
              .primaryColor
              .withOpacity(0.9), //Color.fromRGBO(0, 0, 0, 0.07),
          height: 40,
  ...
  void toggleExpanded() {
    if (widget.isExpandable) {
      ...
      if (widget.sizeChanged != null) {
        widget.sizeChanged(isExpanded);
      }
    }
  }
